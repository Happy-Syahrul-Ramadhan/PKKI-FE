    ...
    <section className="bg-white text-black py-16 mt-10 md:px-20">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="space-y-4">
          {/* Accordion Item 1 */}
          <div className="bg-gray-200 p-4 rounded-lg cursor-pointer" onClick={() => toggleAccordion(0)}>
            <div className="flex justify-between">
              <h4 className="font-semibold text-lg">Apa itu PKKI?</h4>
            ...
            >
              {(open === 0 || open === null) && (
                <p className="mt-2 text-sm text-justify transform origin-top transition-all duration-500">
          ...
          {/* Accordion Item 2 */}
          <div className="bg-gray-200 p-4 rounded-lg cursor-pointer" onClick={() => toggleAccordion(1)}>
            <div className="flex justify-between">
              <h4 className="font-semibold text-lg">Bagaimana cara bergabung?</h4>
          ...
          {/* Accordion Item 3 */}
          <div className="bg-gray-200 p-4 rounded-lg cursor-pointer" onClick={() => toggleAccordion(2)}>
            <div className="flex justify-between">
              <h4 className="font-semibold text-lg">Apa manfaat bergabung dengan PKKI?</h4>
          ...
          {/* Accordion Item 4 */}
          <div className="bg-gray-200 p-4 rounded-lg cursor-pointer" onClick={() => toggleAccordion(3)}>
            <div className="flex justify-between">
              <h4 className="font-semibold text-lg">Bagaimana cara melaporkan inovasi?</h4>
